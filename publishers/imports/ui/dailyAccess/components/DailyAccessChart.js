...
export default function DailyAccessChart({
  ...
  return (
    <div className="tab-content package1">
      <div className="row">
        <div>
          <h2 className="col-xs-12 text-center gray-title">Daily Pass
            <OverlayTrigger
              placement="top"
              overlay={
                <Tooltip id="tooltip">
      ...
      <div className="row">
        <div className="col-xs-12">
          <table>
            <tbody>
              <tr>
                <td>Total earned via daily pass today:</td>
                <td>${(totalEarnedToday).toFixed(2)}</td>
              </tr>
              <tr>
                <td>Total earned via daily pass as of today:</td>
